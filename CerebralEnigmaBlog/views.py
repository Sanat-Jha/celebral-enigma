...
def addpost(request):
    if request.method == "POST":
        ...
        try:
            threading.Thread(target=send_new_blog_post_email, args=(post.title, post.description, f"http://Cerebral-enigma.onrender.com/post/{title}", [subscriber.email for subscriber in EmailSubs.objects.all()])).start()
